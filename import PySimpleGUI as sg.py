...
class TaskManager(tk.Tk):
    def __init__(self):
        ...
        self.geometry("900x700")  # Ajustată pentru layout vertical

        # Configurare frame-uri și liste
        self.tasks = {"To Do": [], "In Progress": [], "Done": []}
        self.frames = {}
        self.lists = {}
        self.priorities = {'Low': '#ADD8E6', 'Medium': '#FFD700', 'High': '#FF6347'}
        ...
        # Adăugarea task-urilor cu priorități și dată/oră în partea dreaptă
